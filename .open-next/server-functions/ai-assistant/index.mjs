...
// .open-next/server-functions/ai-assistant/open-next.config.mjs
var open_next_config_exports = {};
__export(open_next_config_exports, {
  default: () => open_next_config_default
});
var config, open_next_config_default;
...
// .open-next/server-functions/ai-assistant/index.mjs
...
globalThis.nextVersion = "15.5.19";
...
var defaultHandler = async (internalEvent, options) => {
  ...
  return runWithOpenNextRequestContext({ isISRRevalidation: false, waitUntil: options?.waitUntil, requestId }, async () => {
    const handler3 = await Promise.resolve().then(() => (init_edgeFunctionHandler(), edgeFunctionHandler_exports));
